...
/*============= Cartbox Toggler ==============*/
  ...
  /*============= Chat Dropdown Toggler ==============*/
  function chatDropdownToggler() {
    var trigger = $('.chatDropdown_active'),
      container = $('.miniChatDropdown__active');
    trigger.on('click', function (e) {
      e.preventDefault();
      container.toggleClass('is-visible');
    ...
    $('.miniChatDropdown__close').on('click', function () {
      container.removeClass('is-visible');
    });
  }
  chatDropdownToggler();
...
/*====== Price Slider Active ======*/ 
    $('#slider-range').slider({
        ...
        min: 0,
        max: 200,
        values: [Number($('#minPrice').text()), Number($('#maxPrice').text())],
